...
const PostItemEditHintDialog = (props) => {
  ...
  return (
    <Dialog open={props.open} onClose={props.handleClose} style={{ maxHeight: '90%' }}>
      ...
      <DialogContent>
        <Box>
          <Box className={classes.title}>1. 目次だけ読んでみよう！</Box>
          <Divider />
          <Box className={classes.content}>
            一番王道のやり方！
            <br />
            <br />
            目次だけ目を通し、興味・関心のあった箇所を見つけてみましょう。
            <br />
        ...
        <Box>
          <Box className={classes.title}>2. 他人レビューを読んでみよう！</Box>
          <Divider />
          <Box className={classes.content}>
            思い切って、先にレビューを読んでしまうのも有効な手段です。
            <br />
            <br />
        ...
        <Box>
          <Box className={classes.title}>3. 欲望に忠実になろう！</Box>
          <Divider />
          <Box className={classes.content}>
            ・お金がほしい！
            <br />
        ...
        <Box>
          <Box className={classes.title}>5. 読みながら随時更新していこう</Box>
          <Divider />
          <Box className={classes.content}>
            メンタルマップは、必ずしも最初に完成させる必要はありません。
            <br />
            <br />
