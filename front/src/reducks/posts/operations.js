...
export const exchangeRegisteredAndReadingPost = (id) => {
  return async (dispatch) => {
    ...
    const apiUrl =
      process.env.REACT_APP_API_V1_URL + '/registered/posts/exchange_registered_and_reading_post/' + String(id)
...
export const saveReadingPost = (title, url, author, image, postItems) => {
  return async (dispatch) => {
    ...
    postItems.map((postItem) => post_items_attributes.push({ content: postItem.content }))
