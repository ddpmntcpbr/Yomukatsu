        ...
        <Box py={4}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} sm={6} className={classes.image}>
              ...
              <Box fontSize="0.8rem" py={1}>書籍をセットして、</Box>
            </Grid>
            <Grid item xs={12} sm={6} className={classes.image}>
              <img src={intro2} alt="intro2" width="80%"/>
              <Box fontSize="0.8rem" py={1}>メンタルマップを作成!</Box>
            </Grid>
          </Grid>
        </Box>
        ...
        <Box py={4}>
          ...
          <Box className={classes.content} component="h6">
            ...
            <Grid container spacing={1}>
              <Grid item xs={12} sm={6} className={classes.image}>
                ...
                <Box fontSize="0.8rem" py={1}>すぐに読み始める場合は「読書中にセット」を選び、後々で読む予定ならば「登録のみ」を 選んでください</Box>
              </Grid>
              <Grid item xs={12} sm={6} className={classes.image}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} sm={6} className={classes.image}>
              ...
              <Box fontSize="0.8rem" py={1}>ページ下部の「登録リスト」から、書籍を選択</Box>
            </Grid>
            <Grid item xs={12} sm={6} className={classes.image}>
              <img src={intro6} alt="intro6" width="80%"/>
              <Box fontSize="0.8rem" py={1}>「読書開始書籍にセット」を押すことで、この書籍を「読書中」と入れ替えられる</Box>
            </Grid>
          </Grid>
        </Box>
          ...
          <Box className={classes.content} component="h6" mt={2}>
            ...
            <Container maxWidth="xs">
              <Box className={classes.image}>
                ...
                <Box fontSize="0.8rem" py={1}>本を読みながら新しいマップ項目が思いついたら、どんどん追加していこう！</Box>
              </Box>
            </Container>
          </Box>
        </Box>
        ...
        <Box py={4}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} sm={6} className={classes.image}>
              ...
              <Box fontSize="0.8rem" py={1}>OKをクリックすると</Box>
            </Grid>
            <Grid item xs={12} sm={6} className={classes.image}>
              <img src={intro9} alt="intro9" width="80%"/>
              <Box fontSize="0.8rem" py={1}>書籍が「完読済み」リストへ移動!</Box>
            </Grid>
          </Grid>
          <Box my={4}>
          ...
          <Grid container spacing={1}>
            <Grid item xs={12} sm={6} className={classes.image}>
              ...
              <Box fontSize="0.8rem" py={1}>ツイート内容はデフォルトから変更することも可能</Box>
            </Grid>
            <Grid item xs={12} sm={6} className={classes.image}>
              <img src={intro11} alt="intro11" width="80%"/>
              <Box fontSize="0.8rem" py={1}>タイムライン表示イメージ</Box>
          ...
          <Container maxWidth="xs">
            <Box className={classes.image}>
              ...
              <Box fontSize="0.8rem" py={1}>実際にシェアされるページ。メンタルマップの中身は公開されませんので、気軽につぶやこう！</Box>
            </Box>
          </Container>
        </Box>
        </Box>
