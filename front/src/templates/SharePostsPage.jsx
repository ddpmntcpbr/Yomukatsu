      ...
      {isNonEmptyArray(post) ? (
        <Box>
          ...
          <Box component={Paper} p={2} className={classes.paper}>
            ...
            <Box px={4} mt={4}>
              ...
              <Box my={2}>
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      'https://books.rakuten.co.jp/search?sitem=' + post.title + '&l-id=pc-search-box&x=29&y=15'
                    )
                  }
            ...
            <Box mt={6}>
              <Button fullWidth={true} className={classes.appButton} onClick={() => dispatch(push('/'))}>
                積読解消アプリ
                <br />
                Yomukatsu のご利用はコチラ!
              </Button>
